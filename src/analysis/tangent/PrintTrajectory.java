 ...
 * @author tadaki
 */
public class PrintTrajectory extends AbstractAnalysis {
    ...
    public static void main(String args[]) throws IOException {
        ...
        double lambda = 0.957;
        double initX = .45;
        PrintTrajectory sys = new PrintTrajectory(lambda);
     ...
     * @throws IOException
     */
    public PrintTrajectory(double lambda) throws IOException {
        super(lambda);
    }
